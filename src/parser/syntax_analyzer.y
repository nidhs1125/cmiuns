...
%token <node> ARRAY ELSE IF INT FLOAT RETURN VOID WHILE IDENTIFIER INTEGER FLOATPOINT ADD SUB MUL DIV LT LTE GT GTE EQ NEQ SEMICOLON COMMA LPARENTHESE RPARENTHESE LBRACKET RBRACKET LBRACE RBRACE ASSIN LETTER
